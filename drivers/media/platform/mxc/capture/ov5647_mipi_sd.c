			    ...
			    enum ov5647_mode mode, enum ov5647_mode orig_mode)
{
	...
	/*else if (ov5647_data.pix.pixelformat == V4L2_PIX_FMT_SBGGR10)//Add SvD
		mipi_csi2_set_datatype(mipi_csi2_info, MIPI_DT_RAW10);
	
	else if (ov5647_data.pix.pixelformat == V4L2_PIX_FMT_GREY)//Add SvD
		mipi_csi2_set_datatype(mipi_csi2_info, MIPI_DT_RAW8);
	
	else if (ov5647_data.pix.pixelformat == V4L2_PIX_FMT_SBGGR8)//Add SvD
		mipi_csi2_set_datatype(mipi_csi2_info, MIPI_DT_RAW8);*/
	...
	if (mode == ov5647_mode_INIT) {
		...
		pModeSetting = ov5647_setting_60fps_VGA_640_480; //Edit SvD
...
MODULE_AUTHOR("Freescale Semiconductor, Inc.");//Edited by SvD
